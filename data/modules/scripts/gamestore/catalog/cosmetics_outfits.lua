return {
	...
	offers = {
		...
		},
		{
			...
			addon = 3,
			description = "{character}\n{info} colours can be changed using the Outfit dialog\n{info} includes basic outfit and 2 addons which can be selected individually\n\n<i>Tending to a hive takes patience, care, and a healthy respect for things that sting. Suit up as a Beekeeper and harvest the sweetest rewards Tibia has to offer, no smoker required.</i>",
			type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
		},
		{
			...
			addon = 3,
			description = "{character}\n{info} colours can be changed using the Outfit dialog\n{info} includes basic outfit and 2 addons which can be selected individually\n\n<i>Every strike a step, every parry a turn - the Blade Dancer treats the battlefield like a stage, and their enemies never see the final act coming.</i>",
			type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
		},
		{
		...
		},
		{
			...
			addon = 3,
			description = "{character}\n{info} colours can be changed using the Outfit dialog\n{info} includes basic outfit and 2 addons which can be selected individually\n\n<i>Descending from on high with wings ablaze, the Celestial Avenger metes out judgment upon those who would threaten Tibia. Neither shadow nor sin escapes its righteous gaze.</i>",
			type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
		},
		{
		...
		},
		{
			...
			addon = 3,
			description = "{character}\n{info} colours can be changed using the Outfit dialog\n{info} includes basic outfit and 2 addons which can be selected individually\n\n<i>Forged in the fires of a battlefield long forgotten, the Doom Knight's armour carries the weight of every foe it has ever felled. Those who see it approach rarely stay to ask why it's called Doom.</i>",
			type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
		},
		{
		...
		},
		{
			...
			addon = 3,
			description = "{character}\n{info} colours can be changed using the Outfit dialog\n{info} includes basic outfit and 2 addons which can be selected individually\n\n<i>Every adventurer needs a break from armour and robes now and then. Dressed to the nines in the Formal Dress outfit, you'll turn heads at any gala, coronation, or diplomatic reception Tibia has to offer.</i>",
			type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
		},
		{
		...
		},
		{
			...
			addon = 3,
			description = "{character}\n{info} colours can be changed using the Outfit dialog\n{info} includes basic outfit and 2 addons which can be selected individually\n\n<i>Years of discipline and training have honed your body into a weapon in its own right. The Martial Artist outfit needs no sword or shield - your fists and focus are more than enough.</i>",
			type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
		},
		{
		...
		},
		{
			...
			addon = 3,
			description = "{character}\n{info} colours can be changed using the Outfit dialog\n{info} includes basic outfit and 2 addons which can be selected individually\n\n<i>Crown, cloak, and bearing befitting a throne - the Royal Costume lets any adventurer carry themselves like the ruler of their own small kingdom, at least for an evening.</i>",
			type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
		},
		{
